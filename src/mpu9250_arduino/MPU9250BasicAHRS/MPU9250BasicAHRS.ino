...
float magCalibration[3] = {1.0, 1.0, 1.0}, magbias[3] = {95, 75, 90};  // Factory mag calibration and mag bias
...
{  
  ...
  // Pass gyro rate as rad/s
    ...
    // Unit: G
    Serial.print("MAG:");
    Serial.print(mx / 1000,4);Serial.print(",");
    Serial.print(my / 1000, 4);Serial.print(",");
    Serial.print(mz / 1000, 4); Serial.print("\n");
